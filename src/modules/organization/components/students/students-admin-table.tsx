...
export function StudentsAdminTable({ students, onView }: StudentsAdminTableProps) {
  return (
    <Table className="min-w-[880px] text-xs sm:min-w-[940px] sm:text-sm">
      <TableHeader>
        <TableRow className="hover:bg-transparent">
          ...
          <TableHead className={`${headClass} whitespace-normal leading-snug`}>Learning Type</TableHead>
          <TableHead className={`${headClass} whitespace-normal leading-snug`}>Learning Teacher</TableHead>
          <TableHead className={`${headClass} whitespace-normal leading-snug`}>Password Status</TableHead>
      ...
      <TableBody>
        {students.map((student) => (
          <TableRow key={student.id}>
            ...
            <TableCell className={cellClass}>{student.curriculum}</TableCell>
            ...
            <TableCell className={cellClass}>
              <Badge variant="outline" className={`whitespace-nowrap px-2 py-0 text-xs ${PASSWORD_STYLES[student.passwordStatus]}`}>

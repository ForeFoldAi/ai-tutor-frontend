...
export default function TutorLessonPlannerPage() {
  ...
  return (
    <PageShell className="lg:overflow-hidden" contentClassName="min-h-0 flex-1">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="flex min-h-0 flex-1 flex-col gap-3">
        ...
        <TabsContent value="plan" className="mt-0 min-h-0 flex-1 overflow-y-auto lg:overflow-hidden">
          <div className="grid min-h-0 gap-4 lg:h-full lg:grid-cols-[clamp(18rem,30%,26rem)_minmax(0,1fr)] lg:overflow-hidden">
            <div className="flex min-h-0 flex-col lg:overflow-hidden">
              {needsProfileSetup ? (
                <p className="mb-2 shrink-0 rounded-md border border-amber-200 bg-amber-50 px-3 py-2 text-xs text-amber-900 dark:border-amber-900/50 dark:bg-amber-950/30 dark:text-amber-100">
                  {individual
